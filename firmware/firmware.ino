...
#define MATRIX_TILE_WIDTH 7  // width of each individual matrix tile
#define MATRIX_TILE_HEIGHT 7 // height of each individual matrix tile
...
FastLED_NeoMatrix *matrix = new FastLED_NeoMatrix(
    ...
    MATRIX_TILE_H,
    MATRIX_TILE_V,
    NEO_MATRIX_TOP + NEO_MATRIX_LEFT + NEO_MATRIX_COLUMNS + NEO_MATRIX_ZIGZAG + NEO_TILE_TOP + NEO_TILE_LEFT + NEO_TILE_PROGRESSIVE);
...
void handleRoot() {
  ...
  if (server.hasHeader("text")) {
    ...
    text = server.header("text");
  } else {
    content += "No \"text\" header found, scrolling text has no been updated.";
  }
